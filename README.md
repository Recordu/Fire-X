...
## New Updated Repo is [Here](https://github.com/Recordu/FIREXUSERBOT).
...
## Heroku salesforce error solution.
   ...
   - Your Forked Url is looking Like: `https://github.com/Recordu/Fire-X` ; YourGitName = Your Github Username.
   - Now use this url to deploy: `Heroku.com/deploy?template=your forked url here` e.g.  `heroku.com/deploy?template=https://github.com/Recordu/Fire-X`; Here we put YourGitName = maihindu.   
